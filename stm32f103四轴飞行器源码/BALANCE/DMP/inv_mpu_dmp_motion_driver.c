...
//			short temp;
    ...
    if (dmp.feature_mask & DMP_FEATURE_SEND_ANY_GYRO) {
        ...
        sensors[0] |= INV_XYZ_GYRO;
			...
			//取平均值，去掉最高的两个  暂时去掉，占用系统运行时间
//		if(gyro_count<8)//记8次数，gyro_count从1开始的
//			{
//				gyro_0[gyro_count]=gyro[0];
//				gyro_1[gyro_count]=gyro[1];
//				gyro_count++;
//			}
//			else
//			{
...
//					for(i=0;i<7-j;i++)
//					{
//						if(gyro_0[i]>gyro_0[i+1])
//						{
//							temp=gyro_0[i];gyro_0[i]=gyro_0[i+1];gyro_0[i+1]=temp;
//						}
//						if(gyro_1[i]>gyro_1[i+1])
//						{
//							temp=gyro_1[i];gyro_1[i]=gyro_1[i+1];gyro_1[i+1]=temp;
//						}
//					}
//				}
//				for(i=0;i<6;i++)
//				{
//					gyro_0_average+=gyro_0[i];
//					gyro_1_average+=gyro_1[i];
//				}
//				gyro_0_average=gyro_0_average/6;
//				gyro_1_average=gyro_0_average/6;
//			}
    }
